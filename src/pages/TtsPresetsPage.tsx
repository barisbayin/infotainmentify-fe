              ...
              {detailLoading ? (
                ...
                <>
                  ...
                  <div className="space-y-4">
                    <div>
                      <HelpLabel help="Workflow TTS stage secimlerinde gorunen isim. Voice, dil ve tempo farkini isimde belirtmek iyi olur.">
                    ...
                    <div>
                      <HelpLabel help="Ses uretimini yapacak provider baglantisi. Voice ID ve model bu provider tarafinda gecerli olmali.">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="col-span-2">
                      <HelpLabel help="Provider tarafindaki ses kimligi. Uzun videoda dogal, yorucu olmayan ve dil telaffuzu iyi bir voice sec.">
                        Voice ID / İsim{" "}
                    ...
                    <div>
                      <HelpLabel help="Uretilen sesin dil/locale kodu. Script diliyle uyumlu olmali; ornek: tr-TR, en-US.">
                        Dil Kodu
                      </HelpLabel>
                      <Input
                    ...
                    <div>
                      <HelpLabel help="Provider destekliyorsa TTS modelini override eder. Bos kalirsa backend/provider varsayilani kullanilir.">
                        Model (Opsiyonel)
                      </HelpLabel>
                      <Input
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <HelpLabel help="Konusma hizini belirler. Long-form icin 0.95-1.08 arasi genelde daha dinlenebilir; cok hizli anlatim yorabilir.">
                          Hız (Rate)
                        </HelpLabel>
                        <NumberInput
                      ...
                      <div>
                        <HelpLabel help="Ses perdesini degistirir. Kucuk dokunuslar dogal kalir; buyuk degerler yapay/karikaturize hissettirebilir.">
                          Ton (Pitch)
                        </HelpLabel>
                        <NumberInput
                          value={form.pitch}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <HelpLabel help="ElevenLabs ses tutarliligi. Yuksek deger daha stabil, dusuk deger daha ekspresif ama degisken sonuc verebilir.">
                          Stability
                        </HelpLabel>
                        <NumberInput
                      ...
                      <div>
                        <HelpLabel help="Ses netligi/benzerlik ayari. Uzun anlatimda anlasilabilirligi artirir; cok yuksek deger bazi seslerde sertlesebilir.">
                          Clarity
                        </HelpLabel>
                        <NumberInput
                          value={form.clarity}
                      ...
                      <div className="col-span-2">
                        <HelpLabel help="Sesin oyunculuk/duygu vurgusunu artirir. Long-form anlatimda dusuk-orta deger daha dogal kalir.">
                          Style Exaggeration
                        </HelpLabel>
                        <NumberInput
