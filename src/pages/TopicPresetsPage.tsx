              ...
              {detailLoading ? (
                ...
                <>
                  <div className="space-y-4">
                    <div>
                      <HelpLabel help="Workflow Topic stage secimlerinde gorunen isim. Konu stratejisini ve dil/format farkini isimde belirtmek preset secimini kolaylastirir.">
                    ...
                    <div>
                      <HelpLabel help="Topic fikirlerini uretecek AI baglantisi. Trend/context yorumlamasi guclu olan baglantiyi secmek uzun video fikrini daha saglam baslatir.">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <HelpLabel help="Konu ve premise uretiminde kullanilacak model. Daha yaratici ama tutarli fikirler icin iyi reasoning/context dengesi olan model sec.">
                          Model Adı
                        </HelpLabel>
                        <Input
                      ...
                      <div>
                        <HelpLabel help="Modelin yaraticilik seviyesi. 0.4-0.7 kontrollu fikir, 0.8+ daha cesur ama daginik sonuc verebilir.">
                          Sıcaklık (Temp)
                        </HelpLabel>
                        <NumberInput
                    ...
                    <div>
                      <HelpLabel help="Topic ciktisinin dili. Script, TTS ve STT presetleriyle ayni dil ailesinde tutmak zinciri daha temiz yapar.">
                        Dil
                      </HelpLabel>
                      <Input
                        value={form.language}
                  ...
                  <div>
                    <HelpLabel help="Presetin hangi kanal/format icin kullanildigini hatirlatan not alani. Uretim sonucunu etkilemez.">
                      Açıklama
                    </HelpLabel>
                    <Input
                  ...
                  {/* Keywords JSON */}
                  <div>
                    <HelpLabel help="Prompt'a eklenen sabit baglam kelimeleri. JSON array olarak tut; kanal temasi, yasakli alanlar veya tekrar eden konu havuzu icin kullan.">
