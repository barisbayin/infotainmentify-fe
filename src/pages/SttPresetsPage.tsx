              ...
              {detailLoading ? (
                ...
                <>
                  <div className="space-y-4">
                    <div>
                      <HelpLabel help="Workflow STT stage secimlerinde gorunen isim. Caption tipi veya model/dil farkini isimde belirtmek iyi olur.">
                        Preset Adı
                      </HelpLabel>
                      <Input
                        value={form.name}
                    ...
                    <div>
                      <HelpLabel help="Transcription islemini yapacak AI baglantisi. TTS cikti dilini ve dosya formatini desteklemeli.">
                        AI Bağlantısı
                      </HelpLabel>
                      <Select
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <HelpLabel help="STT modeli. Whisper benzeri modellerde kelime zamanlamasi ve dil algisi caption kalitesini belirler.">
                        Model
                      </HelpLabel>
                      <Input
                    ...
                    <div>
                      <HelpLabel help="Ses dili. auto algilama kullanilabilir ama uzun videoda sabit dil kodu daha tutarli transcript verebilir.">
                        Dil Kodu
                      </HelpLabel>
                      <Input
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-3 mb-3">
                      <div className="flex flex-col gap-1">
                        <HelpLabel className="text-[10px] text-zinc-500" help="Kelime bazli zaman damgasi uretir. Karaoke/highlight caption ve daha hassas altyazi yerlesimi icin acik olmali.">
                      ...
                      <div className="flex flex-col gap-1">
                        <HelpLabel className="text-[10px] text-zinc-500" help="Birden fazla konusmaci varsa ayirim yapmaya calisir. Tek anlatimli videolarda genelde kapali kalabilir.">
                  ...
                  <div>
                    <HelpLabel help="STT modeline ozel isimleri, terimleri ve kanal jargonunu hatirlatir. Yanlis yazilan kelimeleri azaltir.">
                      İpucu (Prompt)
                    </HelpLabel>
                    <Textarea
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <HelpLabel help="Transcription varyasyonunu belirler. 0.0 en deterministik ve caption icin genelde en guvenli baslangictir.">
                        Sıcaklık (Temp)
                      </HelpLabel>
                      <NumberInput
                    ...
                    <div>
                      <HelpLabel help="Transcript icindeki kufur/hassas ifadeleri filtrelemeye calisir. Belgesel/analiz iceriginde anlam kaybi yaratabilecegi icin bilincli kullan.">
                        Küfür Filtresi
                      </HelpLabel>
                      <Toggle
                        label="Filtrele"
