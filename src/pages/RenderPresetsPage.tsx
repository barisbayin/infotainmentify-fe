...
const LONG_FORM_RENDER_FORM: SaveRenderPresetDto = {
  name: "Long Form Render - 1080p 16:9",
  outputWidth: 1920,
  outputHeight: 1080,
  fps: 30,
  bitrateKbps: 9000,
...
export default function RenderPresetsPage() {
  ...
  const applyLongFormStarter = () => {
    setForm({
      ...LONG_FORM_RENDER_FORM,
      name: form.name || LONG_FORM_RENDER_FORM.name,
    });
    setActiveTab("video");
    toast.success("Long Form render starter uygulandi.");
  };
            ...
            <div className={`flex-1 overflow-y-auto p-5 space-y-6 scrollbar-thin scrollbar-thumb-zinc-700 ${detailLoading ? "opacity-50 pointer-events-none grayscale" : ""}`}>
              {detailLoading && !form.name ? (
                ...
                <>
                  {/* Common: Ad */}
                  <div>
                    <HelpLabel help="Workflow Render ve SceneLayout stage secimlerinde gorunen isim. Oran, FPS ve kalite bandini isimde belirtmek iyi olur.">
                      Preset Adı
                    </HelpLabel>
                    <Input
                      value={form.name}
                  ...
                  {activeTab === "video" && (
                     <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        {/* Aspect Ratio Grid */}
                        <div>
                            <HelpLabel className="mb-2" help="Final video canvas boyutu. Long Form icin 1920x1080/16:9, Shorts icin 1080x1920/9:16 kullan.">
                              Çözünürlük & Format
                            </HelpLabel>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <HelpLabel help="Final videonun kare hizi. Shorts/standart video icin 30 FPS guvenli, oyun/aksiyon icin 60 FPS dusunulebilir.">
                                  FPS
                                </HelpLabel>
                                <Select
                            ...
                            <div>
                                <HelpLabel help="Video kalite/dosya boyutu dengesi. 1080p shorts icin 6000-8000 Kbps iyi baslangic; long-form 16:9 icin 8000+ dusunulebilir.">
                                  Bitrate (Kbps)
                                </HelpLabel>
                                <NumberInput
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <HelpLabel help="FFmpeg encoder preset'i. Fast hizli render, slow daha iyi sikistirma/kalite dengesi verir ama uzun surer.">
                                  Encoder Hizi
                                </HelpLabel>
                                <Select
                            ...
                            <div>
                                <HelpLabel help="Final container formati. Platform uyumlulugu icin mp4 en guvenli varsayilan.">
                                  Dosya Formati
                                </HelpLabel>
                                <Select
                      ...
                      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        {form.captionSettings.enableCaptions && (
                            <>
                                 <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <HelpLabel help="Caption icin genel stil etiketi. Render tarafinda asil etki font/renk/animasyon ayarlarindan gelir.">
                                          Stil Şablonu
                                        </HelpLabel>
                                        <Select
                                    ...
                                    <div>
                                        <HelpLabel help="Altyazinin ekrana giris/akis hissi. Long-form icin daha sakin animasyonlar izleyiciyi daha az yorar.">
                                          Animasyon
                                        </HelpLabel>
                                        <Select
                                 ...
                                 <div className="grid grid-cols-2 gap-4">
                                     <div>
                                         <HelpLabel help="ASS altyazida kullanilacak font adi. Sistemde bulunmayan fontlarda fallback devreye girebilir.">
                                           Yazı Fontu
                                         </HelpLabel>
                                          <Input
                                     ...
                                     <div className="flex gap-2">
                                          <div className="flex-1">
                                             <HelpLabel help="ASS altyazi font boyutu. Dikey 1080x1920 videoda 48-64 arasi genelde okunur.">
                                                Boyut
                                             </HelpLabel>
                                          ...
                                          <div className="flex-1">
                                             <HelpLabel help="Yazi etrafindaki kontur kalinligi. Parlak/karisik gorsellerde okunurlugu ciddi artirir.">
                                                Kenarlik
                                             </HelpLabel>
                                 ...
                                 <div className="grid grid-cols-2 gap-4">
                                     <div>
                                         <HelpLabel help="Caption yerlesimi. Shorts icin Bottom ama UI/altyazi carpismasina gore margin ile yukari almak iyi olur.">
                                            Pozisyon
                                         </HelpLabel>
                                         <Select
                                     ...
                                     <div>
                                         <HelpLabel help="Bottom caption konumunda altyazinin ekran altindan uzakligi. Long-form 16:9 icin 60-100px genelde yeterlidir.">
                                           Alt Boşluk (px)
                                         </HelpLabel>
                                 ...
                                 <div className="mt-4">
                                    <HelpLabel help="Karaoke/shorts tarzinda satir basina az kelime daha iyi ritim verir. 2-3 genelde guvenli.">
                                      Satir Basina Max Kelime
                                    </HelpLabel>
                                    <NumberInput 
                          ...
                          <div className="grid grid-cols-1 gap-2 border-t border-zinc-800 pt-4">
                              ...
                              {form.audioMixSettings.enableDucking && (
                                  <div className="pl-4 border-l-2 border-zinc-800 ml-2 mt-2">
                                      <HelpLabel className="text-[10px] mb-1" help="Ducking aktifken muzik/sfx seviyesinin konusma sirasinda ne kadar kisilacagini belirler.">
                                        Kısma Oranı (%{form.audioMixSettings.duckingFactor})
                                      </HelpLabel>
                           ...
                           <Toggle
                            ...
                            {form.visualEffectsSettings.enableKenBurns && (
                                 <div className="bg-zinc-950/30 p-3 rounded-xl border border-zinc-800">
                                      <HelpLabel className="text-[10px] mb-2" help="Ken Burns acikken gorsellere uygulanacak yavas zoom miktari. Long-form'da dusuk deger daha dogal durur.">
                                        Zoom Yoğunluğu
                                      </HelpLabel>
                                      <div className="flex items-center gap-3">
                            ...
                            <Toggle
                                label="Auto B-roll Cut"
                                description="Uzun sahneleri otomatik kisa visual beat'lere boler; tek gorselin uzun sure ekranda kalmasini engeller."
                                checked={form.visualEffectsSettings.enableAutoBroll}
                                onChange={v => setForm({...form, visualEffectsSettings: {...form.visualEffectsSettings, enableAutoBroll: v}})}
                            />

                            {form.visualEffectsSettings.enableAutoBroll && (
                              <div className="grid gap-3 rounded-xl border border-zinc-800 bg-zinc-950/30 p-3 md:grid-cols-3">
                                <div>
                                  <HelpLabel className="text-[10px]" help="Bu sureden uzun sahneler parcalanir. 18-25 sn long-form icin iyi bir baslangic.">
                                    Min Sahne
                                  </HelpLabel>
                                  <NumberInput
                                    value={form.visualEffectsSettings.minSceneDurationForBrollSec}
                                    min={6}
                                    max={90}
                                    step={1}
                                    onChange={v => setForm({...form, visualEffectsSettings: {...form.visualEffectsSettings, minSceneDurationForBrollSec: v}})}
                                  />
                                  <div className="mt-1 text-center text-[10px] text-zinc-500">sn</div>
                                </div>
                                <div>
                                  <HelpLabel className="text-[10px]" help="Her visual beat'in yaklasik suresi. 8-10 sn uzun videoda sakin ama hareketli durur.">
                                    Beat Suresi
                                  </HelpLabel>
                                  <NumberInput
                                    value={form.visualEffectsSettings.brollSegmentDurationSec}
                                    min={4}
                                    max={30}
                                    step={1}
                                    onChange={v => setForm({...form, visualEffectsSettings: {...form.visualEffectsSettings, brollSegmentDurationSec: v}})}
                                  />
                                  <div className="mt-1 text-center text-[10px] text-zinc-500">sn</div>
                                </div>
                                <div>
                                  <HelpLabel className="text-[10px]" help="Tek sahnede olusabilecek maksimum visual beat sayisi. Cok yuksek deger render komutunu buyutur.">
                                    Max Cut
                                  </HelpLabel>
                                  <NumberInput
                                    value={form.visualEffectsSettings.maxBrollCutsPerScene}
                                    min={2}
                                    max={12}
                                    step={1}
                                    onChange={v => setForm({...form, visualEffectsSettings: {...form.visualEffectsSettings, maxBrollCutsPerScene: v}})}
                                  />
                                  <div className="mt-1 text-center text-[10px] text-zinc-500">adet</div>
                                </div>
                              </div>
                            )}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <HelpLabel help="Sahneler arasi gecis tipi. Crossfade yumusak, none daha hizli ve keskin his verir.">
                                      Gecis Efekti
                                    </HelpLabel>
                                    <Select
                                ...
                                <div>
                                    <HelpLabel help="Final videoya genel renk karakteri verir. Marka/kanal stilini sabitlemek icin kullan.">
                                      Renk Filtresi
                                    </HelpLabel>
                                    <Select
                          ...
                          <Toggle
                           ...
                           {form.brandingSettings.enableWatermark && (
                               <div className="space-y-4 p-4 rounded-xl bg-zinc-950/30 border border-zinc-800">
                                    <div>
                                        <HelpLabel help="Watermark olarak yazilacak metin. Bos birakilirsa sadece gorsel watermark kullanilabilir.">
                                          Filigran Metni
                                        </HelpLabel>
                                        <Input
                                    ...
                                    <div>
                                        <HelpLabel help="Logo/marka gorseli dosya yolu. Assets sayfasindan Branding tipi gorsel secilebilir.">
                                          Filigran Görseli
                                        </HelpLabel>
                                        <div className="flex gap-2">
                                            <Input
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <HelpLabel help="Watermark'in ekrandaki konumu. YouTube kontrolleri ve altyazi ile carpmayacak bir kose sec.">
                                              Pozisyon
                                            </HelpLabel>
                                            <Select
                                        ...
                                        <div>
                                            <HelpLabel help="Watermark saydamligi. 0.3-0.5 arasi genelde markayi gosterir ama videoyu bogmaz.">
                                              Opaklık
                                            </HelpLabel>
